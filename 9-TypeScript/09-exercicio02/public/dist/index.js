...
function addSatellite(name, planet) {
    ...
    alert(`O satélite ${name} foi adicionado ao planeta ${planet.name}.`);
}
function removeSatellite(name, planet) {
    planet.satellites = planet.satellites.filter(satellite => satellite !== name);
    alert(`O satélite ${name} foi removido do planeta ${planet.name}.`);
}
...
function promptValidPlanet(callbackfn) {
    const planetName = prompt('Qual é o nome do planeta?');
